...
const inclusions = [
  'Appliance interiors and exteriors (fridge, oven, microwave)',
  'Cabinets, drawers, and closets wiped inside and out',
  'Detail on doors, switches, handles, and trim',
  'Bathrooms fully descaled and sanitized',
  'Floors vacuumed, swept, and mopped thoroughly',
  'Final polish of entry glass and visible smudges',
];

export default function ServiceMove() {
  return (
    <>
      <SeoHead />
      <header className="relative overflow-hidden bg-[#0B1120] text-white">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/15 px-4 py-2 rounded-full text-sm font-semibold mb-4">
            ...
            Empty-home, deposit-safe clean
          </div>
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Move-In / Move-Out Cleaning</h1>
          <p className="text-lg text-slate-100 max-w-3xl">
            White-glove clean that makes new homes feel brand new and helps protect move-out deposits.
          </p>
        </div>
      </header>
          ...
          <section className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <h2 className="text-2xl font-bold text-[#0B1120]">Start fresh or leave spotless</h2>
              </div>
            </div>
          ...
          <section className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <div className="lg:col-span-2 bg-white border border-slate-200 rounded-2xl shadow-sm p-6">
              ...
              <ul className="space-y-3 text-slate-700">
                <li>• Renters securing deposits with a spotless handoff</li>
                <li>• Buyers wanting move-in ready kitchens, baths, and closets</li>
                <li>• Landlords preparing units for fast, photo-ready turnover</li>
              </ul>
            </div>

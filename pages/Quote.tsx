                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {cities.map((city) => (
                        <button
                          ...
                          className={`p-3 rounded-lg border-2 text-left font-medium transition-all cursor-pointer hover:scale-[1.02] active:scale-[0.98] ${selectedCity === city ? 'border-[#C5A065] bg-[#C5A065]/10 shadow-sm' : 'border-slate-200 hover:border-[#C5A065] hover:shadow-md'
                            }`}
                        >
                          {city}
                        </button>
                    ...
                    <div className="space-y-3">
                      {[
                        ...
                        <button
                          ...
                          className={`w-full p-4 rounded-lg border-2 text-left transition-all cursor-pointer hover:scale-[1.01] active:scale-[0.99] ${formData.serviceType === s.value ? 'border-[#C5A065] bg-[#C5A065]/10 shadow-sm' : 'border-slate-200 hover:border-[#C5A065] hover:shadow-md'
                            }`}
                        >
                ...
                <div className="flex gap-3 mt-8">
                  {step > 1 && (
                    <button type="button" onClick={() => setStep((s) => s - 1)}
                      ...
                      className="flex-1 py-3 border-2 border-slate-200 rounded-lg font-semibold transition-all cursor-pointer hover:bg-slate-50 hover:border-[#C5A065] hover:shadow-md hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:hover:border-slate-200 disabled:hover:shadow-none">
                      Back
                    </button>
                  )}
                  {step < 4 ? (
                    <button
                      ...
                      className="flex-1 bg-[#C5A065] text-[#0B1120] py-3 rounded-lg font-bold transition-all cursor-pointer hover:bg-[#947638] hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] disabled:bg-slate-300 disabled:hover:bg-slate-300 disabled:hover:scale-100 disabled:hover:shadow-none disabled:cursor-not-allowed flex items-center justify-center gap-2"
                    >
                    ...
                    <button
                      ...
                      className="flex-1 bg-[#0B1120] text-white py-3 rounded-lg font-bold transition-all cursor-pointer hover:bg-[#0B1120]/90 hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] disabled:bg-slate-400 disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:hover:shadow-none flex items-center justify-center gap-2"
                    >

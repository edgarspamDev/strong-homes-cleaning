import { CheckCircle, Sparkles, Shield, ArrowRight } from 'lucide-react';
import { Link } from 'react-router-dom';
import { SeoHead } from '../SeoHead';

const inclusions = [
  'Dust all reachable surfaces, fixtures, and sills',
  'Vacuum carpets; sweep and mop hard floors',
  'Bathrooms: toilets, tubs/showers, sinks, mirrors, chrome',
  'Kitchen: counters, sink, backsplash, appliance exteriors',
  'Beds made, light tidying of common areas',
  'Entry glass and spot-check doors/handles',
];
      ...
      <header className="relative overflow-hidden bg-[#0B1120] text-white">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/15 px-4 py-2 rounded-full text-sm font-semibold mb-4">
            ...
            Recurring upkeep for busy schedules
          </div>
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Standard Cleaning</h1>
          <p className="text-lg text-slate-100 max-w-3xl">
            Reliable weekly or bi-weekly cleaning that keeps kitchens, baths, and living spaces guest-ready with the same trusted crews.
          </p>
        </div>
      </header>
          ...
          <section className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <h2 className="text-2xl font-bold text-[#0B1120]">Consistent, careful upkeep</h2>
              </div>
            </div>
          ...
          <section className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <div className="lg:col-span-2 bg-white border border-slate-200 rounded-2xl shadow-sm p-6">
              ...
              <ul className="space-y-3 text-slate-700">
                <li>• Families needing predictable weekly or bi-weekly upkeep</li>
                <li>• Busy professionals who want reliable start-of-week freshness</li>
                <li>• Small offices or studios needing consistent light detail</li>
              </ul>
            </div>
            <div className="bg-[#0B1120] text-white rounded-2xl p-6 shadow-lg shadow-black/20">
              <p className="text-sm text-slate-200 mb-2">Ready for a cleaner routine?</p>
              <h3 className="text-2xl font-bold mb-4">Book your recurring visit</h3>
              <p className="text-sm text-slate-200 mb-5">Vetted crews with supplies provided. Same-day reminders included.</p>
              <div className="space-y-3">
                <Link
                  to="/quote"
                  className="block w-full text-center bg-[#C5A065] text-[#0B1120] font-semibold py-3 rounded-lg hover:bg-[#947638] hover:scale-[1.02] transition-all cursor-pointer"
                >
                  Get my estimate
                </Link>
                <Link

      ...
      <div className="relative z-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            ...
            className="bg-[#C5A065] text-[#0B1120] px-8 py-4 rounded-lg font-semibold text-lg shadow-lg shadow-black/20 hover:bg-[#947638] hover:scale-[1.02] hover:shadow-2xl transition-all cursor-pointer"
          >
            Book a Cleaning
          </a>
          <Link
            to="/quote"
            className="border-2 border-[#C5A065] text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-[#C5A065]/25 hover:scale-[1.02] transition-all cursor-pointer"
          >
            Get a Free Quote
          </Link>
        </div>
